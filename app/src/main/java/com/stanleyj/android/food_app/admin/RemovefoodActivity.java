...
import com.stanleyj.android.food_app.UpdateRemoveActivity;
import com.stanleyj.android.food_app.ViewHolder;
...
public class RemovefoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_removefood);
        pd = new ProgressDialog(this);

        getSupportActionBar().setTitle("Remove Food"); // set back button to action bar
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerviewR);
            ...
            mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (!dataSnapshot.hasChildren()) {
                        Toast.makeText(RemovefoodActivity.this, "No result found", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                        return;
                    }
                }
                            ...
                            viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    ...
                                    try {
                                        ...
                                        AlertDialog alertDialog = new AlertDialog.Builder(RemovefoodActivity.this).create();
